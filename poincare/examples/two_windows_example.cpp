...
int main() {
    poincare::Window window(600, 400, "Double window example: A", poincare::ViewMode::kView2D, true);
    window.SetColor(glm::vec3(0.5f));

    poincare::Window window2(500, 500, "Double window example: B", poincare::ViewMode::kView2D, true, window.glfw_window);
